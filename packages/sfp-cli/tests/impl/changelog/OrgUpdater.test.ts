...
describe('Given an OrgsUpdater', () => {
    ...
    it('should update an org with the release, for an old release', () => {
        ...
        new OrgsUpdater(releaseChangelog, oldRelease1, 'SIT', releaseChangelog.releases[1]).update();
    ...
    it("should update an org's retryCount, for an old release", () => {
        ...
        new OrgsUpdater(releaseChangelog, oldRelease2, 'DEV', releaseChangelog.releases[0]).update();
